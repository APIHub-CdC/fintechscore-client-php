...
namespace FintechScore\MX\Client\Api;
...
use FintechScore\MX\Client\ApiException;
use FintechScore\MX\Client\Configuration;
use FintechScore\MX\Client\HeaderSelector;
...
class FintechScoreApi
{
    ...
    {
        $returnType = '\FintechScore\MX\Client\Model\Respuesta';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\FintechScore\MX\Client\Model\Respuesta',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\FintechScore\MX\Client\Model\Errores',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
